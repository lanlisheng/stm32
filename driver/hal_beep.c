...
// unsigned short NoteFreqAry[12] =
// {955,901,851,803,758,715,675,637,601,568,536,506}; unsigned short
// NoteFreqAry[12] = {253,268,284,300,318,337,357,379,401,425,450,477};

// unsigned short NoteFreqAry[2] =
// {253,268,284,300,318,337,357,379,401,425,450,477};
unsigned short NoteFreqAry[30] = {

    BP_FRQ1,  BP_FRQ2,  BP_FRQ3,  BP_FRQ4,  BP_FRQ5,  BP_FRQ6,
    BP_FRQ7,  BP_FRQ8,  BP_FRQ9,  BP_FRQ10, BP_FRQ11, BP_FRQ12,
    BP_FRQ13, BP_FRQ14, BP_FRQ15, BP_FRQ15, BP_FRQ14, BP_FRQ13,
    BP_FRQ12, BP_FRQ11, BP_FRQ10, BP_FRQ9,  BP_FRQ8,  BP_FRQ7,
    BP_FRQ6,  BP_FRQ5,  BP_FRQ4,  BP_FRQ3,  BP_FRQ2};
...
static void hal_BeepConfig(void) {
  ...
  GPIO_PinRemapConfig(GPIO_PartialRemap_TIM3,
                      ENABLE); // Timer3部分重映射  TIM3_CH2->PB5
  ...
  TIM_TimeBaseStructure.TIM_Period =
      100; // 设置在下一个更新事件装入活动的自动重装载寄存器周期的值
  TIM_TimeBaseStructure.TIM_Prescaler =
      SystemCoreClock / 1000000 - 1; // 设置用来作为TIMx时钟频率除数的预分频值
  ...
  TIM_OC1PreloadConfig(TIM3,
                       TIM_OCPreload_Enable); // 使能TIM3在CCR2上的预装载寄存器
